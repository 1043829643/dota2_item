...
def build():
    ...
    W(li("Searing Chains: Unit Count increased from 3 to 4", b(3, 4)))
    W(ul_close())
    ...
    W(li("Void: Level 5 now also increases Attack Slow from 50 to 60", b(50, 60)))
    W(ul_close())
    W(subgroup("Talents"))
    W(ul_open())
    ...
    W(li("Shackleshot: Damage Buff Duration decreased from 6s to 3/4/5/6s", b(6, [3, 4, 5, 6])))
    W(ul_close())
