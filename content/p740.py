...
def build():
    ...
    W(li("Moved Watchers to the low ground and slightly closer to the Tier 1 towers. These Watchers now have vision over the Wisdom Shrines at night", t("MISC")))
    ...
    W(li("Moved Wisdom Shrines to the low ground and slightly closer to the Tier 1 towers", t("MISC")))
    W(ul_close())
