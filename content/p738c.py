...
def build():
    ...
    W(li("Forced movement applied by Batrider's allies to the lassoed target from certain abilities no longer cancel lasso", t("MISC"),
        extra=inline_note(
            ...
            "Keeper of the Light's Will-o-Wisp<br>"
            "Lich's Sinister Gaze<br>"
            "Lone Druid's (and Spirit Bear's) Savage Roar<br>"
            "Muerta's Dead Shot<br>"
            "Pudge's Dismember<br>"
            "Ringmaster's Wheel of Wonder<br>"
            "Shadow Fiend's Requiem of Souls<br>"
            "Terrorblade's Terror Wave<br>"
            "Tinker's Defense Matrix (blink with Translocator facet)<br>"
            "Tinker's Warp Flare (still applies damage, but does not move the target)<br>"
    ...
    W(li("The following abilities continue to break the lasso", t("MISC"),
        extra=inline_note(
            "Centaur Warrunner's Hitch a Ride<br>"
            "Chaos Knight's Reality Rift<br>"
            "Disruptor's Glimpse<br>"
            "Kunkka's X Marks the Spot<br>"
            "Magnus' Reverse Polarity<br>"
            "Mars' Arena of Blood (created by an ally)<br>"
    ...
    W(ul_open())
    W(li("Uproar: Now also provides stacks upon being Silenced", t("NEW")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Now indicates the exact position of each enemy hero in the area without revealing their identity", t("NEW")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Now also slows movement of the affected enemy by 45%", t("NEW"), extra=inline_note("Similarly to vision, movement speed is recovering over the debuff time")))
    W(ul_close())
