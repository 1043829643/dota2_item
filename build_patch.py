...
W(hero_header("Batrider"))
W(ul_open())
W(li("Base Armor decreased by 1", bstat_h("Batrider", "ArmorPhysical", "7.41a", -1)))
W('''<li>From 2 to 1</li>''')
W(ul_close())
W(ability("Firefly"))
W(ul_open())
...
W(hero_header("Ember Spirit"))
W(ul_open())
W(li("Base Damage decreased by 3", bstat_h("Ember Spirit", "AttackDamageMin", "7.41a", -3)))
W('''<li>From 35 to 32</li>''')
...
W(ul_open())
W(li("Base Health Regen decreased by 1.25", bstat_h("Night Stalker", "StatusHealthRegen", "7.41a", -1.25)))
W('''<li>From 1.5 to 0.25</li>''')
W(ul_close())
...
W(hero_header("Skywrath Mage"))
W(ul_open())
W(li("Base Mana Regen increased by 0.25", bstat_h("Skywrath Mage", "StatusManaRegen", "7.41a", 0.25)))
W('''<li>From 0.25 to 0.5</li>''')
W(ul_close())
...
W(ul_open())
W(li("Base Movement Speed increased from 310 to 315", b(310, 315)))
W(li("Base Health Regen increased by 0.5", bstat_h("Anti-Mage", "StatusHealthRegen", "7.41", 0.5)))
W('''<li>From 1.0 to 1.5</li>''')
W(ul_close())
W(ability("Mana Break"))
W(ul_open())
...
W(hero_header("Chaos Knight"))
W(ul_open())
W(li("Base Damage increased by 3", bstat_h("Chaos Knight", "AttackDamageMin", "7.41", 3)))
W('''<li>From 39 to 42</li>''')
W(li("Damage on level 1 increased from 53–73 to 56–76", t("BUFF")))
W(ul_close())

# Chen
W(hero_header("Chen"))
W(ability("Chen Penitence"))
W(ul_open())
...
# Death Prophet
W(hero_header("Death Prophet"))
W(ability("Death Prophet Spirit Siphon"))
W(ul_open())
...
W(ul_close())
W(ability("Juggernaut Blade Dance"))
W(ul_open())
...
W(ul_open())
W(li("Base Damage decreased by 3", bstat_h("Lifestealer", "AttackDamageMin", "7.41", -3)))
W('''<li>From 19 to 16</li>''')
...
# Phantom Lancer
W(hero_header("Phantom Lancer"))
W(ability("Phantom Lancer Spirit Lance"))
W(ul_open())
...
W(hero_header("Void Spirit"))
W(ul_open())
W(li("Base Mana Regen decreased by 0.6", bstat_h("Void Spirit", "StatusManaRegen", "7.41", -0.6)))
W('''<li>From 0.6 to 0</li>''')
W(ul_close())
...
W(ul_close())
W(ability("Windrunner Focusfire"))
W(ul_open())
...
W(hero_header("Anti-Mage"))
W(ul_open())
W(li("Base Armor increased by 1", bstat_h("Anti-Mage", "ArmorPhysical", "7.40c", 1)))
W('''<li>From 1 to 2</li>''')
W(ul_close())
W(ability("Persecutor"))
W(ul_open())
...
W(hero_header("Dawnbreaker"))
W(ul_open())
W(li("Base damage increased by 6", bstat_h("Dawnbreaker", "AttackDamageMin", "7.40c", 6)))
W('''<li>From 27 to 33</li>''')
...
W(hero_header("Death Prophet"))
W(ul_open())
W(li("Base Armor increased by 1", bstat_h("Death Prophet", "ArmorPhysical", "7.40c", 1)))
W('''<li>From 0 to 1</li>''')
W(ul_close())
...
W(hero_header("Drow Ranger"))
W(ul_open())
W(li("Base Damage decreased by 2", bstat_h("Drow Ranger", "AttackDamageMin", "7.40c", -2)))
W('''<li>From 32.5 to 30.5</li>''')
...
W(hero_header("Legion Commander"))
W(ul_open())
W(li("Base armor decreased by 1", bstat_h("Legion Commander", "ArmorPhysical", "7.40c", -1)))
W('''<li>From 0.0 to -1</li>''')
W(ul_close())
W(ability("Legion Commander Outfight Them"))
W(ul_open())
W(li("Ability reworked", t("MISC")))
...
W(hero_header("Lifestealer"))
W(ul_open())
W(li("Base Damage increased by 10", bstat_h("Lifestealer", "AttackDamageMin", "7.40c", 10)))
W('''<li>From 19 to 29</li>''')
...
W(hero_header("Nature's Prophet"))
W(ul_open())
W(li("Minimum Base damage increased by 4 ", bstat_h("Nature's Prophet", "AttackDamageMin", "7.40c", 4)))
W('''<li>From 21 to 25</li>''')
...
W(hero_header("Omniknight"))
W(ul_open())
W(li("Base Armor decreased by 1", bstat_h("Omniknight", "ArmorPhysical", "7.40c", -1)))
W('''<li>From 3 to 2</li>''')
...
W(li("Base Armor decreased by 1", bstat_h("Outworld Destroyer", "ArmorPhysical", "7.40c", -1)))
W('''<li>From 1 to 0</li>''')
...
W(hero_header("Rubick"))
W(ul_open())
W(li("Base Damage increased by 1", bstat_h("Rubick", "AttackDamageMin", "7.40c", 1)))
W('''<li>From 29 to 30</li>''')
...
W(hero_header("Terrorblade"))
W(ul_open())
W(li("Base Armor increased by 1", bstat_h("Terrorblade", "ArmorPhysical", "7.40c", 1)))
W('''<li>From 5 to 6</li>''')
W(ul_close())
...
W(li("Base Armor decreased by 1", bstat_h("Undying", "ArmorPhysical", "7.40c", -1)))
W('''<li>From 1 to 0</li>''')
W(ul_close())
...
W(hero_header("Void Spirit"))
W(ul_open())
W(li("Base Damage decreased by 4", bstat_h("Void Spirit", "AttackDamageMin", "7.40c", -4)))
W('''<li>From 24 to 20</li>''')
...
W(hero_header("Wraith King"))
W(ul_open())
W(li("Base Armor decreased by 1", bstat_h("Wraith King", "ArmorPhysical", "7.40c", -1)))
W('''<li>From 1 to 0</li>''')
W(ul_close())
...
W(li("Base Armor decreased by 1", bstat_h("Zeus", "ArmorPhysical", "7.40c", -1)))
W('''<li>From 2 to 1</li>''')
W(ul_close())
