...
W(li("Arctic Blast damage increased from 200 to 260", b(200, 260, l=True)))
...
W(li("Impact damage rescaled from 50 to 20/35/50/65", b(50, [20, 35, 50, 65], l=True)))
...
W(ul_close())
W(subnote("Damage at level 1 changed from 46–50 to 47–51"))
...
W(ul_close())
W(subnote("Damage at level 1 decreased from 53–61 to 52–60"))
W(ability("Ice Path"))
W(ul_open())
...
W(li("Base Agility increased from 20 to 22", b(20, 22)))
W(ul_close())
W(subnote("Damage at level 1 increased from 42–46 to 44–48"))
W(ability("Savage Roar"))
W(ul_open())
...
W(ul_close())
W(subnote("Damage at level 1 decreased from 52–58 to 51–57"))
...
W(ul_close())
W(subnote("Damage at level 1 decreased from 49–53 to 46–50"))
W(subgroup("Talents"))
W(ul_open())
...
W(ul_close())
W(ability("Essence Flux", slug="obsidian_destroyer_equilibrium"))
W(ul_open())
...
W(ul_open())
W(li("Now shows the overhead \"Blinded\" text over affected units", t("NEW")))
W(ul_close())
...
W(ul_open())
W(li("Cooldown decreased from (50s - 3s per 2 levels ups) to (35s - 1s per level up)", t("NERF")))
W(ul_close())
...
W(ul_open())
W(li("Initial and maximum stock increased from 4 to 5", b(4, 5)))
W(li("No longer has half duration when cast on an ally", t("NERF"),
     extra=inline_note("Now heals for half the amount per second instead.")))
W(ul_close())
...
W(ul_open())
W(li("Observer Wards cannot be planted within 300 units of another Observer Ward from the same team that has been planted within the last second", t("NERF")))
W(li("Plant no longer increased by cast range increases", t("NERF")))
W(ul_close())
W(item_header("Sentry Ward"))
W(ul_open())
W(li("Sentry Wards cannot be planted within 300 units of another Sentry Ward from the same team that has been planted within the last second", t("NERF")))
W(li("Plant no longer increased by cast range increases", t("NERF")))
W(ul_close())
W(item_header("Smoke of Deceit"))
W(ul_open())
W(li("Can be used directly from the backpack", t("MISC")))
W(li("Has no cooldown when entering the main inventory from the backpack", t("MISC")))
W(ul_close())
W(item_header("Tango"))
W(ul_open())
W(li("Initial and maximum stock increased from 8 to 10", b(8, 10)))
W(li("Shared Tango now heals for half the amount per second", t("REWORK")))
W(ul_close())
W(item_header("Roshan's Banner"))
W(ul_open())
W(li("Now upgrades with each subsequent drop", t("REWORK")))
...
W(ul_open())
W(li("Ghost Form magic damage vulnerability decreased from 40% to 30%", b(40, 30)))
W(ul_close())
...
W(li("Bloodpact spell lifesteal multiplier decreased from 4x to 3x", t("NERF")))
W(ul_close())
W(item_header("Boots of Bearing"))
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("Now also requires Ring of Tarrasque (1700)", t("REWORK")))
W(li("No longer requires a 1700g recipe. Total cost unchanged at 4225", t("NERF")))
W(li("Health Regen bonus increased from +15 to +18", b(15, 18)))
W(ul_close())
W(item_header("Crimson Guard"))
W(ul_open())
W(li("Guard buff is no longer dispellable", t("NERF")))
W(ul_close())
W(item_header("Dagon"))
W(ul_open())
W(li("Total cost decreased from 2850 to 2800 due to Voodoo Mask cost decrease", b(2850, 2800, l=True)))
W(li("Total cost for all levels decreased from 2850/4000/5150/6300/7450 to 2800/3950/5100/6250/7400", b([2850, 4000, 5150, 6300, 7450], [2800, 3950, 5100, 6250, 7400], l=True)))
W(ul_close())
W(item_header("Diffusal Blade"))
W(ul_open())
W(li("Manabreak no longer applied by illusions", t("NERF")))
W(ul_close())
W(item_header("Disperser"))
W(ul_open())
W(li("Suppress now applies basic dispel to any target", t("REWORK")))
W(li("Manabreak no longer applied by illusions", t("NERF")))
W(ul_close())
W(item_header("Ethereal Blade"))
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("Now requires Ultimate Orb (2800) instead of Aether Lens (2275)", t("REWORK")))
W(li("Recipe cost decreased from 1600 to 900. Total cost decreased from 5375 to 5200", b(1600, 900, l=True)))
W(li("No longer provides +300 Mana, +3 Mana Regen, or +250 Cast Range", t("NERF")))
W(li("All Attributes bonus increased from +8 to +24", b(8, 24)))
W(li("Ether Blast magic damage vulnerability decreased from 40% to 30%", b(40, 30)))
W(li("Ether Blast attributes as damage changed from (1.5x the target's primary attribute) to (1x the sum of the caster's attributes)", t("MISC")))
W(ul_close())
W(item_header("Glimmer Cape"))
W(ul_open())
W(li("Recipe cost increased from 350 to 450. Total cost unchanged at 2150 due to Shadow Amulet cost decrease", b(350, 450, l=True)))
W(ul_close())
W(item_header("Guardian Greaves"))
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("No longer requires a Buckler", t("NERF")))
W(li("Recipe cost decreased from 1450 to 1125. Total cost decreased from 5050 to 4300", b(1450, 1125, l=True)))
W(li("Armor bonus increased from +4 to +5", b(4, 5, l=True)))
W(li("Guardian Aura no longer provides armor", t("NERF")))
W(li("Guardian Aura no longer provides additional bonuses when below 25% health to anyone but the wearer", t("NERF")))
W(li("Guardian Aura no longer provides increased armor and increased mana regeneration when below 25% health", t("NERF")))
W(li("Still provides bonus health regeneration to the wearer when below 25% health", t("MISC")))
W(ul_close())
W(item_header("Hand of Midas"))
W(ul_open())
...
W(li("Behemoth's Blood: New Passive Ability", t("MISC")))
W(li("Wearer's health regen is increased by 1.5% of missing health", t("BUFF")))
W(li("Multiple instances of Behemoth's Blood don't stack", t("MISC")))
W(ul_close())
W(item_header("Heaven's Halberd"))
W(ul_open())
W(li("Disarm is now only dispellable by strong dispels", t("REWORK")))
W(ul_close())
W(subnote("Still does not pierce debuff immunity"))
W(ul_open())
...
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("Now requires Crown (450) instead of Diadem (1000)", t("REWORK")))
W(li("Recipe cost increased from 800 to 1340. Total cost unchanged at 2250 due to Iron Branch cost increase", b(800, 1340, l=True)))
W(li("All Attributes bonus decreased from +9 to +7", b(9, 7)))
W(li("Energy Charge automatic charge gain time increased from 8s to 10s", b(8, 10)))
...
W(li("Energy Charge active now also increases the target's incoming Healing Amplification by 10% for 4s", t("REWORK")))
W(ul_close())
W(subnote("This occurs before the Energy Charge heal"))
W(item_header("Khanda"))
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("Now requires Soul Booster (3000) instead of Tiara of Selemene (1800)", t("REWORK")))
W(li("No longer requires a 1200g recipe. Total cost unchanged at 5600", t("NERF")))
W(li("Now also provides +7 Health Regeneration", t("REWORK")))
W(li("Mana Regen bonus decreased from +8 to +3", b(8, 3)))
W(li("Health bonus increased from +200 to +450", b(200, 450)))
W(li("Mana bonus increased from +200 to +450", b(200, 450)))
W(ul_close())
...
W(ul_open())
W(li("Nullify can no longer target invulnerable units", t("NERF")))
W(ul_close())
W(item_header("Octarine Core"))
W(ul_open())
W(li("Can no longer be disassembled", t("NERF")))
W(li("Now also requires a 200g recipe", t("REWORK")))
...
W(item_header("Perseverance"))
W(ul_open())
W(li("Can now be disassembled", t("REWORK")))
W(ul_close())
W(item_header("Pipe of Insight"))
W(ul_open())
W(li("Recipe cost increased from 700 to 800", b(700, 800, l=True)))
W(li("Total cost unchanged at 3725 due to Ring of Tarrasque cost decrease", t("MISC")))
W(ul_close())
W(item_header("Phylactery"))
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("Now requires Perseverance (1400) instead of Point Booster (1200)", t("REWORK")))
W(li("Recipe cost decreased from 300 to 200. Total cost increased from 2500 to 2600", b(300, 200, l=True)))
W(li("No longer provides +200 Health and +200 Mana", t("NERF")))
W(li("Now also provides +6.5 Health Regen and +2.5 Mana Regen", t("REWORK")))
W(ul_close())
W(item_header("Radiance"))
W(ul_open())
W(li("Evasion bonus increased from +15% to +25%", b(15, 25)))
W(li("Burn no longer causes enemies to miss 15% of their attacks", t("NERF")))
W(li("Burn no longer does extra damage to illusions", t("NERF")))
W(ul_close())
W(item_header("Refresher Orb"))
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("No longer requires Cornucopia", t("NERF")))
W(li("Recipe cost increased from 200 to 1600. Total cost unchanged at 5000 due to Ring of Tarrasque and Tiara of Selemene cost decrease", b(200, 1600, l=True)))
W(li("No longer provides +10 Damage", t("NERF")))
W(li("Health Regen bonus decreased from +18 to +12", b(18, 12)))
W(li("Mana Regen bonus decreased from +8 to +6", b(8, 6)))
W(ul_close())
W(item_header("Revenant's Brooch"))
W(ul_open())
W(li("Recipe cost increased from 600 to 650. Total cost unchanged at 3300 due to Voodoo Mask cost decrease", b(600, 650, l=True)))
W(ul_close())
W(item_header("Scythe of Vyse"))
W(ul_open())
W(li("Recipe cost increased from 600 to 700", b(600, 700, l=True)))
W(li("Total cost unchanged at 5200 due to Tiara of Selemene cost decrease", t("MISC")))
W(ul_close())
...
W(item_header("Shiva's Guard"))
W(ul_open())
W(li("Arctic Blast no longer does extra damage to illusions", t("NERF")))
W(ul_close())
W(item_header("Silver Edge"))
W(ul_open())
W(li("Total cost decreased from 5800 to 5700 due to Shadow Amulet cost decrease", b(5800, 5700, l=True)))
W(li("Shadow Walk debuff now caps the target's movement speed to 200. This debuff is not dispellable and does not pierce debuff immunity", t("REWORK")))
W(ul_close())
W(item_header("Urn of Shadows"))
W(ul_open())
...
W(li("Soul Release charges can now be gained by all copies of Urn of Shadows item", t("REWORK")))
W(li("This change is exclusive to Urn of Shadows and doesn't affect Spirit Vessel", t("MISC")))
W(li("Soul Release charges can now be gained by both Urn of Shadows and Spirit Vessel from the same hero death", t("REWORK")))
W(li("Example to show the result of these two changes:", t("MISC")))
W(li("Two allied heroes. Both of them have both Urn of Shadows and Spirit Vessel. An enemy hero dies within 1500 range from them. Both Urns of Shadows will gain a charge. Spirit Vessel will also gain a charge as well, but only for the ally that was closer to the dying enemy", t("MISC")))
W(ul_close())
W(item_header("Spirit Vessel"))
W(ul_open())
W(li("Soul Release charge gain radius increased from 1400 to 1500", b(1400, 1500)))
...
W(ul_open())
W(li("Recipe changed", t("MISC")))
W(li("Now requires Ring of Health (700), Chainmail (550), Circlet (155), and a 320 gold recipe. Total cost unchanged at 1725", t("REWORK")))
W(li("Used to require Helm of Iron Will (975), Crown (450), and a 300 gold recipe", t("MISC")))
W(li("Health Regen bonus increased from +4 to +4.5", b(4, 4.5)))
W(ul_close())
...
W(item_header("Ash Legion Shield"))
W(ul_open())
W(li("Active: Shield Wall. Decreases wearer's movement speed by 12 to give all friendly player-controlled units within 800 radius a 140 physical damage barrier. Duration: 6s. No Mana Cost. Cooldown: 40s", t("MISC")))
W(li("Doesn't affect ward units", t("MISC")))
W(ul_close())
W(item_header("Duelist Gloves"))
W(ul_open())
W(li("Returning as a Tier 1 Neutral Artifact", t("MISC")))
W(li("Passive: Boldness. Provides 20 attack speed if there are any enemy heroes within 1200 units", t("MISC")))
W(ul_close())
W(item_header("Weighted Dice"))
W(ul_open())
W(li("<span class=\\", t("MISC")))
...
W(item_header("Weighted Dice"))
W(ul_open())
W(li("Passive: Loaded. When calculating wearer's base damage or creep bounty from last hits, the value is computed 2 times and the highest value is taken", t("MISC")))
W(ul_close())
...
W(li("Passive: Reciprocity. When attacked, the hero counter-attacks a target within their attack range for 80% of their normal attack damage. Cooldown: 5s. Can't proc attack modifiers", t("NERF")))
W(li("Dormant Curio increases counter-attack damage from 80% to 104%", b(80, 104)))
W(ul_close())
W(item_header("Searing Signet"))
W(ul_open())
W(li("Burn Through total damage increased from 72 to 90", b(72, 90)))
W(li("Dormant Curio Total Damage increased from 93.6 to 117", b(93.6, 117)))
W(li("Burn Through now does 50% less damage to non-hero targets", t("REWORK")))
W(ul_close())
...
W(li("Pollinate Max Health Damage decreased from 12% to 9%", b(12, 9)))
W(li("Dormant Curio Max Health Damage decreased from 15.6% to 11.7%", b(15.6, 11.7)))
W(li("Pollinate Cooldown decreased from 45s to 25s", b(45, 25, l=True)))
W(ul_close())
W(item_header("Psychic Headband"))
W(ul_open())
W(li("Psychic Push can now target allies", t("REWORK")))
W(li("Still can't target the wearer themself", t("NERF")))
W(ul_close())
W(item_header("Unrelenting Eye"))
W(ul_open())
W(li("Moved from Tier 5 to Tier 3", t("MISC")))
W(li("Relentless no longer provides status resistance for nearby enemies", t("NERF")))
W(li("Relentless max slow resistance decreased from 100% to 50%", b(100, 50)))
W(li("Dormant Curio Max Slow Resistance decreased from 130% to 65%", b(130, 65)))
W(li("Relentless slow resistance loss per enemy hero in range decreased from 20% to 10%", b(20, 10)))
W(li("Relentless search radius changed from 600 to the hero's attack range", t("MISC")))
W(ul_close())
...
W(item_header("Flayer's Bota"))
W(ul_open())
W(li("Active: Bloodthirst. Increases wearer's base damage by 15% and attack speed by 30 for 6s. No Mana Cost. Cooldown: 65s", t("MISC")))
W(li("Passive: Bloodrush. The cooldown of Bloodthirst is reset whenever an enemy hero dies with 1200 units", t("MISC")))
W(li("Dormant Curio increases bonus base damage from 15% to 19.5% and attack speed from 30 to 39", b(15, 19.5)))
W(ul_close())
W(item_header("Giant's Maul"))
W(ul_open())
W(li("Crushing Blow critical damage decreased from 150% to 140%", b(150, 140)))
W(li("Dormant Curio critical damage decreased from 195% to 182%", b(195, 182)))
W(ul_close())
W(item_header("Idol of Scree'auk"))
W(ul_open())
W(li("<span class=\\", t("MISC")))
...
W(item_header("Idol of Scree'auk"))
W(ul_open())
W(li("Active: False Flight. Grants phased movement, 50% slow resistance, and 25% evasion for 5s. No Mana Cost. Cooldown: 30s", t("MISC")))
W(li("Dormant Curio increases duration from 5s to 6.5s", b(5, 6.5)))
W(ul_close())
W(item_header("Metamorphic Mandible"))
W(ul_open())
W(li("<span class=\\", t("MISC")))
...
W(item_header("Metamorphic Mandible"))
W(ul_open())
W(li("Active: Pupate. The wearer enters an insect form for 4 seconds, increasing magic resistance by 35% and movement speed by 15%, but decreasing size by 20% and armor by 45%. No Mana Cost. Cooldown: 30s. Can be dispelled. Can't be cast while channeling", t("NERF")))
W(li("Dormant Curio increases duration from 4s to 5.2s", b(4, 5.2)))
W(ul_close())
W(item_header("Rattlecage"))
W(ul_open())
W(li("Returning as a Tier 4 Neutral Artifact", t("MISC")))
W(li("Passive: Reverberate. After taking 180 damage from any source, the wearer fires up to 2 projectiles at random nearby enemies within a 600 unit radius, prioritizing heroes, that deal 110 damage and slows the targets movement and attack speed by 100% for 0.2s", t("MISC")))
W(li("Dormant Curio increases damage from 110 to 143", b(110, 143)))
W(ul_close())
...
W(ul_open())
W(li("Moved from Tier 4 to Tier 5", t("MISC")))
W(li("Blood Invocation area of effect bonus increased from 12% to 16%", b(12, 16)))
W(li("Dormant Curio Area of Effect bonus increased from 15.6% to 20.8%", b(15.6, 20.8)))
W(ul_close())
W(item_header("Riftshadow Prism"))
W(ul_open())
W(li("<span class=\\", t("MISC")))
...
W(item_header("Riftshadow Prism"))
W(ul_open())
W(li("Active: Refract. Spends 10% of the wearer's current health to create a full health illusion that lasts for 20s. The illusion has 50% outgoing damage and 240% incoming damage. No Mana Cost. Cooldown: 30s", t("MISC")))
W(li("Dormant Curio increases illusion outgoing damage from 50% to 65%", b(50, 65)))
W(ul_close())
W(plain_header("Satyr Soulstealer"))
W(ul_open())
W(li("Mana Burn target's intelligence multiplier decreased from 2/2.5/3/4x to 1/1.5/2/2.5x", t("NERF")))
W(ul_close())
W(plain_header("Satyr Trickster"))
W(ul_open())
W(li("Purge can no longer target invulnerable units", t("NERF")))
W(ul_close())
...
W(li("Damage at level 1 decreased by 1 (from 50–60 to 49–59)", t("NERF")))
W(li("The Quickening: Cooldown reduction on hero death decreased from 6s to 5s", b(6, 5, l=True)))
W(ul_close())
...
W(hero_header("Anti-Mage"))
W(ul_open())
W(li("Removed Counterspell Ally ability", t("MISC")))
W(ul_close())
W(ability("Counterspell"))
W(ul_open())
W(li("Aghanim's Shard no longer provides Counterspell Ally ability", t("NERF")))
...
W(ul_close())
W(ability("Battle Hunger"))
W(ul_open())
W(li("No longer has an armor-based damage multiplier", t("NERF")))
W(li("Damage type changed from Physical to Pure", t("MISC")))
W(li("No longer has reduced movement slow against creeps", t("NERF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ul_close())
W(ability("Fiends Grip"))
W(ul_open())
W(li("Aghanim's Scepter Illusion damage taken increased from 200% to 225%", b(200, 225)))
W(ul_close())
...
W(ul_close())
W(ability("Hero Facet"))
W(ul_open())
W(li("No longer has decreased number of +2 All Attributes bonuses", t("NERF")))
W(ul_close())
W(ability("Flamebreak"))
W(ul_open())
W(li("Movement Slow decreased from 8/16/24/32% to 6/12/18/24%", b([8, 16, 24, 32], [6, 12, 18, 24])))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 15 Talent Flaming Lasso Cooldown Reduction increased from 7s to 8s", b(7, 8, l=True)))
W(ul_close())
...
W(li("Call of the Wild Boar: Boar's Base Attack Time worsened from 1.25s to 1.35s", b(1.25, 1.35)))
W(ul_close())
...
W(li("No longer upgraded with neither Aghanim's Shard or Aghanim's Scepter", t("NERF")))
W(ul_close())
W(ability("Bloodrage"))
W(ul_open())
...
W(li("Increases current health as initial damage by 3%. Replaces cooldown with 2 charges with the same charge restoration time", t("MISC")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ability("Hero Facet"))
W(ul_open())
W(li("Visual effect of gold flying towards Bounty Hunter is no longer visible to enemies if Bounty Hunter is invisible", t("NERF")))
W(ul_close())
W(ability("Shadow Walk", slug="bounty_hunter_wind_walk"))
W(ul_open())
...
W(li("Removed Roll Out The Barrel and Drunken Master facets", t("MISC")))
W(li("Removed Primal Companion ability", t("MISC")))
W(li("Removed Belligerent innate ability", t("MISC")))
W(ul_close())
W(ability("Liquid Courage"))
W(ul_open())
W(li("New innate ability. Passive, improves with Brewmaster's level", t("MISC")))
W(li("When Brewmaster drops below 50% Health he gains a Status Resistance buff and his movement speed alternates every 1 second between being faster and being slower. The effect becomes stronger at lower health, scaling from 0 up to max values at 20% Health. Max Status Resistance is 10.5% + 0.5% per Brewmaster's level up, Max Speed Increase is 25%, Max Speed Slow is 10%", t("MISC")))
W(li("Upgraded with Aghanim's Shard", t("MISC")))
W(li("Brewmaster may activate the ability to toss a strong drink to himself or a teammate, granting the max effects of his innate for 5 seconds, and also providing 2% Max HP Regen per second. Cast Range: 800. Mana Cost: 50. Cooldown: 20s", t("MISC")))
W(ul_close())
W(ability("Thunder Clap"))
W(ul_open())
...
W(ul_close())
W(ability("Cinder Brew"))
W(ul_open())
W(li("Now rolls a barrel of ale that deals 40/70/100/130 physical damage to enemies in its path and drenches enemies along the way and around the target location", t("REWORK")))
W(ul_close())
W(ability("Drunken Brawler"))
W(ul_open())
W(li("Moved Brewed Up effect from Cinder Brew to Drunken Brawler", t("MISC")))
W(li("When Brewmaster casts any ability, he becomes Brewed Up for 5 seconds, gaining +150% to his stance bonuses. If he is already Brewed Up, the duration is extended by 1s. After Brewed Up ends, Brewmaster is hungover and cannot become Brewed Up again for 9 seconds", t("NERF")))
...
W(li("Void Stance removed", t("MISC")))
W(li("Stance visual indicator is now always present around Brewmaster", t("REWORK")))
W(li("Stances can now be switched without cancelling channeling or invisibility", t("REWORK")))
W(ul_close())
W(ability("Primal Split"))
W(ul_open())
W(li("Void Brewling removed", t("MISC")))
W(li("Duration increased from 16/18/20s to 16/20/24s", b([16, 18, 20], [16, 20, 24])))
W(li("All Brewlings now receive their respective Drunken Brawler stances", t("REWORK")))
W(li("Earth Brewling's Debuff Immunity ability renamed to Earth Element as it no longer grants Debuff Immunity. Now it provides 80% Status Resistance and 60% Magic Resistance instead", t("NERF")))
W(li("Earth Brewling's Demolish Bonus Building Damage decreased from 50/100/150 to 40/80/120", b([50, 100, 150], [40, 80, 120])))
W(li("Earth Brewling's movement speed increased from 330/350/370 to 330/355/380", b([330, 350, 370], [330, 355, 380])))
W(li("Earth Brewling's damage increased from 25/60/95 to 35/70/105", b([25, 60, 95], [35, 70, 105]), extra=inline_note("From 20–30/55–65/90–100 to 30–40/65–75/100–110")))
W(li("Storm Brewling's damage increased from 20/40/60 to 30/50/70", b([20, 40, 60], [30, 50, 70]), extra=inline_note("From 15–25/35–45/55–65 to 25–35/45–55/65–75")))
W(li("No longer upgraded with Aghanim's Shard", t("NERF")))
W(li("Now upgraded with Aghanim's Scepter", t("REWORK")))
W(li("Allows Brewmaster to cancel the ability early and provides Brewed Up bonus to all Brewlings on cast. Also increases ability's level to 4, improving Brewlings' stats and abilities", t("MISC")))
W(li("Earth: 4100 Health, 8 Health Regen, 135–145 Damage, 9 Armor. Other base stats are unchanged", t("MISC")))
W(li("Hurl Boulder: 200 Damage and 2s Stun Duration", t("MISC")))
W(li("Demolish: 160 Bonus Building Damage", t("MISC")))
W(li("Storm: 2500 Health, 8 Health Regen, 85–95 Damage. Other base stats are unchanged", t("MISC")))
W(li("Wind Walk: 320 Bonus Damage and 55% Bonus Movement Speed", t("MISC")))
W(li("Cyclone: 6s Hero Duration and 100 Damage on Landing", t("MISC")))
W(li("Fire: 1750 Health, 8 Health Regen, 215–225 Damage, 24 Armor. Other base stats are unchanged", t("MISC")))
W(li("Permanent Immolation: 100 Damage per second", t("MISC")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ul_close())
W(ability("Hero Facet 2 Bristleback Viscous Nasal Goo"))
W(ul_open())
W(li("No longer has increased Armor Loss per stack", t("NERF")))
W(ul_close())
W(ability("Viscous Nasal Goo"))
W(ul_open())
...
W(ability("Insatiable Hunger"))
W(ul_open())
W(li("Aghanim's Shard no longer increases duration", t("NERF")))
W(ul_close())
W(ability("Spin Web"))
W(ul_open())
W(li("Broodmother's illusions now also benefit from the web", t("REWORK")))
W(ul_close())
W(ability("Incapacitating Bite"))
W(ul_open())
...
W(hero_header("Chaos Knight"))
W(ul_open())
W(li("Min Base Damage increased by 5", bstat_h("Chaos Knight", "AttackDamageMin", "7.39e", 5)))
W(li("Max Base Damage decreased by 5", bstat_h("Chaos Knight", "AttackDamageMin", "7.39e", -5)))
W(li("Damage at level 1 changed from 48–78 to 53–73", t("MISC")))
W(li("Damage spread decreased from 30 to 20", b(30, 20)))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(li("No longer grants bonus attack range", t("NERF")))
W(li("Now deals 50/75/100/125 pure damage by default", t("REWORK")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(hero_header("Clinkz"))
W(ul_open())
W(li("Removed Suppressive Fire and Engulfing Step facets", t("MISC")))
W(li("Removed Tar Bomb ability", t("MISC")))
W(li("Removed Bone and Arrow innate ability", t("MISC")))
W(ul_close())
W(ability("Infernal Shred"))
W(ul_open())
W(li("New innate ability. Passive, can't be leveled up", t("NERF")))
W(li("Clinkz and his skeletons apply a stacking debuff that causes their attacks to pierce up to 20% of the target's armor. Clinkz applies 2% per attack, and skeletons apply 1%. Debuff lasts 5 seconds", t("MISC"), extra=inline_note("Doesn't affect the target's armor directly. Simply improves attacks only for Clinkz and his skeletons")))
W(ul_close())
W(ability("Strafe"))
W(ul_open())
W(li("Skeleton Archers attack speed factor decreased from 60% to 50%", b(60, 50)))
W(ul_close())
W(ability("Searing Arrows"))
W(ul_open())
W(li("Returning as base ability", t("MISC")))
W(li("Imbues Clinkz's arrows with fire for extra 18/32/46/60 extra damage. Skeleton Archers always fire Searing Arrows with 50% reduced damage. Mana Cost: 10", t("MISC")))
W(li("Skeleton Archers target the enemy attacked by Clinkz with Searing Arrows effect", t("MISC")))
W(ul_close())
W(ability("Death Pact"))
W(ul_open())
W(li("No longer creates Skeleton Archers", t("NERF")))
W(ul_close())
W(ability("Wind Walk"))
W(ul_open())
W(li("Skeleton Archer stats and Aghanim's Scepter upgrade are now part of Skeleton Walk", t("REWORK")))
W(li("Skeleton Archer Duration rescaled from 15/20/25/30s to 20/25/30s", b([15, 20, 25, 30], [20, 25, 30])))
W(li("Also applies to Burning Army", t("MISC")))
W(ul_close())
W(ability("Burning Barrage"))
W(ul_open())
W(li("No longer slows the targets", t("NERF")))
W(ul_close())
W(ability("Burning Army"))
W(ul_open())
W(li("Spawn Interval improved from 0.15s to 0.1s", b(0.15, 0.1)))
...
W(ability("Jetpack"))
W(ul_open())
W(li("Now can be toggled on and off for the duration of the buff. Toggle cooldown: 1s", t("REWORK")))
W(ul_close())
...
W(hero_header("Crystal Maiden"))
W(ul_open())
W(li("Base Damage decreased by 2", bstat_h("Crystal Maiden", "AttackDamageMin", "7.39e", -2)))
...
W(li("Damage at level 1 increased by 1 (from 52–58 to 53–59)", t("BUFF")))
W(ul_close())
W(ability("Vacuum"))
W(ul_open())
W(li("No longer affects invulnerable units", t("NERF")))
W(ul_close())

# Dark Willow
W(hero_header("Dark Willow"))
W(ability("Cursed Crown"))
W(ul_open())
...
W(hero_header("Dawnbreaker"))
W(ul_open())
W(li("Base Damage increased by 1", bstat_h("Dawnbreaker", "AttackDamageMin", "7.39e", 1)))
W(li("Damage at level 1 increased from 49–53 to 50–54", t("BUFF")))
W(ul_close())
W(ability("Solar Guardian"))
W(ul_open())
W(li("Aghanim's Scepter no longer reduces air time or channel time", t("NERF")))
...
W(ability("Witchcraft"))
W(ul_open())
W(li("Movement speed bonus changed from 0.5% per hero level to 0.75% + 0.75% per level up", t("MISC")))
W(ul_close())
W(ability("Exorcism"))
W(ul_open())
W(li("No longer provides 4/8/12% bonus movespeed", t("NERF")))
...
W(li("Removed Devil's Bargain facet", t("MISC")))
W(ul_close())
W(ability("Doom"))
W(ul_open())
...
W(hero_header("Earth Spirit"))
W(ul_open())
W(li("Base Damage decreased by 6", bstat_h("Earth Spirit", "AttackDamageMin", "7.39e", -6)))
W(li("Damage at level 1 decreased from 53–57 to 47–51", t("NERF")))
W(li("Removed Resonance, Stepping Stone, and Ready to Roll facets", t("MISC")))
W(ul_close())
W(ability("Stone Caller"))
W(ul_open())
W(li("Now passively grants +2.5% bonus attack damage per currently unused charge", t("REWORK")))
...
W(li("Max Ability Charges increased from (7 + 1 additional charge at every 5th level) to (7 + 1 per 4 hero level ups)", t("BUFF"), extra=inline_note("Changed from 6 additional charges at levels 5/10/15/20/25/30 to 7 additional charges at levels 5/9/13/17/21/25/29")))
W(ul_close())
W(ability("Boulder Smash"))
W(ul_open())
...
W(ability("Geomagnetic Grip"))
W(ul_open())
W(li("Can now target allied units by default with 550/600/650/700 cast range", t("REWORK")))
W(li("Can't pull allies that are affected by Leash, Root, Bind, Duel, Chronosphere or Black Hole", t("NERF")))
W(li("Aghanim's Shard Reworked", t("MISC")))
W(li("Decreases cooldown by 3s and increases allied unit cast range and speed by 50%", t("MISC"), extra=inline_note("Allied Unit Cast Range to 825/900/975/1050, Allied Unit Pull Speed to 900")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(li("Aghanim's Shard no longer allows Fissure walking", t("NERF")))
W(ul_close())
W(ability("Echo Slam"))
W(ul_open())
...
W(ul_open())
W(li("Return Astral Spirit and Move Astral Spirit sub-abilities can now be used while Elder Titan is disabled", t("REWORK")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
# Enchantress
W(hero_header("Enchantress"))
W(ability("Hero Facet 1 Enchantress Natures Attendants"))
W(ul_open())
W(li("Wisp maximum decreased from 4 to 3", b(4, 3)))
W(ul_close())
W(ability("Rabblerouser"))
W(ul_open())
W(li("Damage amplification changed from 10% + 4% per Enchantress level to 4% + 4% per Enchantress level up", t("MISC")))
W(li("Now also affects units that come under Enchantress' control", t("REWORK")))
W(ul_close())
W(ability("Enchant"))
W(ul_open())
W(li("Creep Attack Damage Bonus decreased from 0/25/50/75 to 0/20/40/60", b([0, 25, 50, 75], [0, 20, 40, 60])))
W(li("Enchanted units may now be bound to a persistent hotkey", t("REWORK")))
W(ul_close())
W(ability("Little Friends"))
W(ul_open())
W(li("Affected creeps now gain damage buff from Rabble-Rouser for the duration in case they did not have it", t("REWORK")))
...
W(ability("Malefice"))
W(ul_open())
W(li("Aghanim's Shard now also spawns an Eidolon if the target dies before the effect expires", t("REWORK")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ability("Time Dilation"))
W(ul_open())
W(li("Now always applies one instance of damage and slow in addition to the per cooldown instances", t("REWORK")))
...
# Grimstroke
W(hero_header("Grimstroke"))
W(ability("Ink Creature"))
W(ul_open())
W(li("Cooldown is now also refreshed if the phantom's target dies before the phantom latches to it", t("REWORK")))
W(ul_close())
W(ability("Soul Chain"))
W(ul_open())
W(li("Ability can now be reflected", t("REWORK")))
W(li("Reflected spells now get casted onto both units affected by Soulbind", t("REWORK")))
W(ul_close())
W(ability("Dark Portrait"))
W(ul_open())
W(li("Illusion Outgoing Damage decreased from 150% to 125%", b(150, 125)))
W(li("Illusion Damage Taken decreased from 350% to 275%", b(350, 275)))
W(ul_close())

# Gyrocopter
W(hero_header("Gyrocopter"))
W(ability("Hero Facet 2 Gyrocopter Rocket Barrage"))
W(ul_open())
W(li("Movespeed Duration decreased from 4.5s to 4s", b(4.5, 4)))
W(ul_close())
W(ability("Call Down"))
W(ul_open())
...
# Hoodwink
W(hero_header("Hoodwink"))
W(ability("Hero Facet 1 Hoodwink Scurry"))
W(ul_open())
W(li("Active Cast Range decreased from 75/150/225/300 to 50/100/150/200", b([75, 150, 225, 300], [50, 100, 150, 200])))
W(li("Active Attack Range decreased from 75/150/225/300 to 50/100/150/200", b([75, 150, 225, 300], [50, 100, 150, 200])))
W(ul_close())
W(ability("Mistwoods Wayfarer"))
W(ul_open())
W(li("Ability can no longer target trees affecting Acorn Shot or Bushwhack", t("NERF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
# Invoker
W(hero_header("Invoker"))
W(ability("Hero Facet 2 Invoker Emp"))
W(ul_open())
W(li("Aghanim's Shard Drag Speed decreased from 150 to 125", b(150, 125)))
W(ul_close())
W(ability("Alacrity"))
W(ul_open())
W(li("Mana Cost decreased from 90 to 75", b(90, 75, l=True)))
W(li("Cast Range increased from 650 to 700", b(650, 700, l=True)))
W(ul_close())
W(ability("Ice Wall"))
W(ul_open())
W(li("Damage increased from [25 + 5 * Exort] to [24 + 6 * Exort]", t("BUFF"), extra=inline_note("From 30/35/40/45/50/55/60/65/70/75 to 30/36/42/48/54/60/66/72/78/84")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 15 Talent Cold Snap Cooldown Reduction increased from 5s to 6s", b(5, 6, l=True)))
...
W(li("Damage at level 1 decreased from 56–58 to 54–56", t("NERF")))
W(ul_close())
W(ability("Blade Fury"))
W(ul_open())
W(li("Mana Cost increased from 105/110/115/120 to 120", b([105, 110, 115, 120], 120, l=True)))
...
W(ul_open())
W(li("Base Intelligence increased from 23 to 24", b(23, 24)))
W(li("Damage at level 1 increased from 43–50 to 44–51", t("BUFF")))
W(ul_close())
W(ability("Blinding Light"))
W(ul_open())
...
W(ul_open())
W(li("Cooldown reduction per level increased from 0.2s to 0.25s", b(0.2, 0.25, l=True)))
W(li("Cooldown on level 1 decreased from 7.8s to 7.75s", b(7.8, 7.75, l=True)))
W(li("Cooldown on level 30 decreased from 2s to 0.5s", b(2, 0.5, l=True)))
W(li("Katana Base Attack Time improved from 2.0s to 1.8s", b(2.0, 1.8)))
W(li("Katana Bonus Agility Base Damage decreased from 20% to 12%", b(20, 12)))
W(ul_close())
W(ability("Kazurai Katana"))
W(ul_open())
W(li("Damage per second rescaled from 5/7/9/11 to 3/6/9/12%", b([5, 7, 9, 11], [3, 6, 9, 12])))
W(li("The active effect may only trigger up to a maximum of 500 stacks", t("MISC")))
W(li("Aghanim's Shard now also increases Max Stacks to 1000 and stack as burst damage from 50% to 100%", b(50, 100)))
W(ul_close())
W(ability("Falcon Rush"))
W(ul_open())
W(li("No longer causes Kez to have a fixed attack rate or any interaction with attack speed", t("NERF")))
W(li("Echo Attack Damage decreased from 45/55/65/75% to 35/40/45/50%", b([45, 55, 65, 75], [35, 40, 45, 50])))
W(li("Echoes now have 50% reduced chance to proc random effects", t("REWORK")))
W(li("Echo with Maelstrom (25% chance) will have a 12.5% chance to proc its passive", t("MISC")))
W(li("Echoes can no longer trigger Marks, but may still create them", t("NERF")))
W(li("However, their chance to mark will be reduced from 18% to 9% due to the proc chance change mentioned before", b(18, 9)))
...
# Leshrac
W(hero_header("Leshrac"))
W(ability("Hero Facet 2 Leshrac Diabolic Edict"))
W(ul_open())
W(li("Duration increased from 6s to 7.5s", b(6, 7.5)))
W(ul_close())
...
W(hero_header("Lina"))
W(ul_open())
W(li("Intelligence gain increased from 3.8 to 4.0", b(3.8, 4.0)))
W(ul_close())
W(ability("Laguna Blade"))
W(ul_open())
...
W(li("Base Damage increased by 4", bstat_h("Lone Druid", "AttackDamageMin", "7.39e", 4)))
W(li("Damage at level 1 increased from 38–42 to 42–46", t("BUFF")))
W(li("Removed Bear With Me and Bear Necessities facets", t("MISC")))
W(li("Removed Gift Bearer innate ability. Its effect is now a part of Summon Spirit Bear ability", t("REWORK")))
W(ul_close())
W(ability("Summon Spirit Bear", slug="lone_druid_spirit_bear"))
W(ul_open())
W(li("Moved to an innate ability. Cannot be leveled up", t("NERF")))
W(li("Ability is moved to the 4th ability slot", t("MISC"), extra=inline_note("D key by default")))
W(li("Spirit Bear now counts as a melee hero for most spells", t("REWORK")))
W(li("Since the bear is now a hero, all unit-related changes moved to a separate Spirit Bear section below. This section is for the summon ability changes only", t("REWORK")))
W(li("Cooldown decreased from 150/140/130/120s to 120s", b([150, 140, 130, 120], 120, l=True)))
W(ul_close())
W(ability("Entangle"))
W(ul_open())
W(li("New Point Targeted basic ability", t("MISC")))
W(li("Allows Lone Druid to Entangle enemies once they gain 5 stacks of this ability. Entangled enemies are unable to move for 1.2/1.6/2/2.4s and take 60/70/80/90 damage per second. When cast, applies 2 stacks to each enemy hero in the area and 5 stacks to enemy creeps, and also empowers Lone Druid for 10 seconds, making him apply 1 stack with each attack on enemy heroes. Enemies are protected from gaining new stacks while they're already Entangled. Radius: 350. Stack Duration: 10s. Cast Range: 700. Mana Cost: 60. Cooldown: 24/22/20/18s", t("MISC")))
W(li("Pierces Debuff Immunity", t("MISC")))
W(li("Lone Druid's Empowered Buff and enemy stack counter debuff are undispellable, Entangled debuff is dispellable", t("MISC")))
W(li("Creeps can't gain stacks from either Lone Druid's and Spirit Bear's attacks, and are Entangled only on cast", t("NERF")))
W(li("Roshan is affected as if he were a hero", t("MISC")))
W(li("Spirit Bear's Entangling Claws reworked. Now it levels up with this ability and passively provides empowered attacks at all times", t("REWORK")))
W(li("Upgraded with Aghanim's Scepter", t("MISC")))
W(li("Increases radius to 450 and hero stacks on cast to 5, instantly Entangling them. Also removes stack protection from Entangled enemies", t("MISC")))
W(ul_close())
W(ability("Spirit Link"))
W(ul_open())
W(li("No longer grants attack speed or shared armor", t("NERF")))
W(li("Now also passively grants +10/20/30/40 movement speed to Lone Druid and +20/40/60/80 to his Spirit Bear", t("REWORK")))
W(li("Lone Druid's attacks now heal the Spirit Bear by default", t("REWORK")))
W(li("No longer upgraded with Aghanim's Scepter", t("NERF")))
W(ul_close())
W(ability("True Form"))
W(ul_open())
W(li("Mana Cost decreased from 200 to 80", b(200, 80, l=True)))
W(li("Duration decreased from 40s to 25s", b(40, 25, l=True)))
W(li("Cooldown decreased from 100s to 60/55/50s", b(100, [60, 55, 50], l=True)))
W(li("No longer grants Entangling Claws and Demolish to Lone Druid", t("NERF")))
W(li("Now also provides 50/90/130 bonus attack damage", t("REWORK")))
...
W(ul_open())
W(li("<span class=\\", t("MISC")))
W(li("Now counts as a Universal melee hero instead of a creep in the following cases", t("REWORK")))
W(li("Spirit Bear's attacks now count as melee hero attacks against:", t("REWORK")))
W(li("Roshan's Banner, Clinkz' Skeleton Archers, Lich's Ice Spire, Phoenix's Supernova, Pugna's Nether Ward, Templar Assassin's Psionic Traps, and Undying's Tombstone", t("MISC")))
W(li("Spirit Bear already did hero damage to Shadow Shaman's Mass Serpent Wards, Couriers, Observer Wards and Sentry Wards", t("MISC")))
W(li("Spirit Bear can now be targeted or affected as a hero by the following abilities:", t("REWORK")))
W(li("Axe's Culling Blade, Bounty Hunter's Track, Earth Spirit's Petrify, Legion Commander's Duel, Lion's Finger of Death, Mars' Spear of Mars, Necrophos' Reaper's Scythe, Slark's Pounce, Terrorblade's Reflection, Terrorblade's Sunder (only if the Bear is not Debuff Immune), and Underlord's Atrophy Aura", t("MISC")))
...
W(li("Now can also break enemy Smoke of Deceit", t("REWORK")))
W(li("Spirit Bear's death will not provide charges for these spells:", t("MISC")))
W(li("Charges for Urn of Shadows and its upgrades, Pudge's permanent Strength from Flesh Heap, Silencer's permanent Int from Brain Drain, Slark's permanent Agility from Essence Shift, and Storm Spirit's stacks for Galvanized", t("MISC")))
W(li("Temporary attribute losses from Silencer's, Slark's and other similar spells still work", t("MISC")))
W(li("Can now capture Watchers and Outposts", t("REWORK")))
W(li("Now starts with a Town Portal Scroll on cooldown the first time it is summoned", t("REWORK")))
W(li("Spirit Bear now receives a copy of Lone Druid's Neutral Item. This copy has an independent cooldown", t("REWORK")))
W(li("Ability order has been changed", t("MISC")))
W(li("OLD: Return, Demolish, Savage Roar, Entangling Claws, Fetch", t("MISC")))
...
W(li("Base Attack Time rescaled from 1.75/1.65/1.55/1.45s to 1.5s", b([1.75, 1.65, 1.55, 1.45], 1.5, l=True)))
W(li("Base Attack Speed increased from 100 to 110", b(100, 110)))
...
W(li("Base Magic Resistance increased from 0% to 25%", b(0, 25), extra=inline_note("Demolish ability no longer passively grants 33% magic resistance")))
W(li("Daytime Vision Range increased from 1400 to 1800", b(1400, 1800)))
W(li("No longer gains 100 health and 5 damage per level", t("NERF")))
W(li("Now gains 4.5 Strength, 4.5 Agility and 0.5 Intelligence per level", t("REWORK")))
W(li("Still has no base attributes, so they are all zeroes at level 1", t("MISC")))
W(li("The Spirit Bear now has a separate Talent Tree", t("REWORK")))
...
W(li("No longer passively grants 33% magic resistance", t("NERF")))
W(li("Now considered a Teleport for the \\", t("REWORK")))
W(li("Ability reworked", t("MISC")))
W(li("Passive, pierces Debuff Immunity, levels up with Lone Druid's Entangle", t("MISC")))
W(li("Allows Spirit Bear to Entangle enemies once they gain 5 stacks of this ability. Entangled enemies are unable to move for 1.2/1.6/2/2.4s and take 60/70/80/90 damage per second. Spirit Bear's attacks are permanently empowered, making it apply 1 stack with each attack on enemy heroes. Enemies are protected from gaining new stacks while they're already Entangled", t("MISC")))
W(li("Stacks are applied only to heroes, creep heroes and Roshan", t("MISC")))
W(li("After fetching an enemy, Spirit Bear will now have an attack command issued towards the target", t("REWORK")))
W(ul_close())
...
W(li("Formation time decreased from 1.2s to 0.9s", b(1.2, 0.9)))
W(li("Rotation Radius decreased from 250 to 225", b(250, 225)))
...
W(hero_header("Magnus"))
W(ul_open())
W(li("Base Damage increased by 1", bstat_h("Magnus", "AttackDamageMin", "7.39e", 1)))
W(li("Damage at level 1 increased from 54–62 to 55–63", t("BUFF")))
W(ul_close())
W(ability("Hero Facet"))
W(ul_open())
W(li("No longer has decreased number of +2 All Attributes bonuses", t("NERF")))
W(ul_close())
W(ability("Reverse Polarity"))
W(ul_open())
...
W(hero_header("Marci"))
W(ul_open())
W(li("Removed Fleeting Fury facet", t("MISC")))
W(ul_close())

# Mars
W(hero_header("Mars"))
W(ability("Gods Rebuke"))
W(ul_open())
W(li("Bonus Damage vs Heroes decreased from 10/15/20/25 to 5/10/15/20", b([10, 15, 20, 25], [5, 10, 15, 20])))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 20 Talent Arena of Blood Cooldown Reduction decreased from 20s to 16s", b(20, 16, l=True)))
W(ul_close())

# Medusa
W(hero_header("Medusa"))
W(ability("Mana Shield"))
W(ul_open())
...
# Mirana
W(hero_header("Mirana"))
W(ability("Hero Facet 3 Mirana Starfall"))
W(ul_open())
W(li("Second Meteor Damage decreased from 100% to 70/80/90/100%", b(100, [70, 80, 90, 100])))
W(ul_close())
W(ability("Starfall"))
W(ul_open())
...
W(hero_header("Monkey King"))
W(ul_open())
W(li("Base Armor decreased by 1", bstat_h("Monkey King", "ArmorPhysical", "7.39e", -1)))
...
# Morphling
W(hero_header("Morphling"))
W(ability("Hero Facet 2 Morphling Adaptive Strike Agi"))
W(ul_open())
W(li("Stun is no longer exclusive to this facet", t("NERF")))
W(ul_close())
...
W(li("Now stuns the target for 0.5s and up to 1.2/1.6/2.0/2.4s when Morphling's Strength is 50% higher than his Agility", t("REWORK")))
W(ul_close())
...
W(ul_close())
W(ability("Hero Facet 1 Naga Siren Rip Tide"))
W(ul_open())
W(li("Damage increased from 25/35/45/55 to 30/40/50/60", b([25, 35, 45, 55], [30, 40, 50, 60])))
W(ul_close())
W(ability("Hero Facet 2 Naga Siren Deluge"))
W(ul_open())
W(li("Cooldown increased from 10/9/8/7s to 13/11/9/7s", b([10, 9, 8, 7], [13, 11, 9, 7], l=True)))
W(ul_close())
W(ability("Ensnare"))
W(ul_open())
W(li("Can no longer target invulnerable units unless this invulnerability is provided by Song of the Siren", t("NERF")))
W(ul_close())
W(ability("Song of The Siren"))
W(ul_open())
W(li("Max HP Regen per second decreased from 2/3/4% to 1/2/3%", b([2, 3, 4], [1, 2, 3])))
W(li("Aghanim's Shard Max HP Regen per second bonus decreased from 2% to 1%", b(2, 1)))
W(li("Total Max HP Regen per second with Aghanim's Shard decreased from 4/5/6% to 2/3/4%", b([4, 5, 6], [2, 3, 4])))
W(ul_close())
...
W(li("Treant attack range increased from 100 to 125", b(100, 125, l=True)))
...
# Necrophos
W(hero_header("Necrophos"))
W(ability("Hero Facet 1 Necrolyte Sadist"))
W(ul_open())
W(li("AOE per Kill reduced from 40 to 35", b(40, 35)))
W(ul_close())
W(ability("Reapers Scythe"))
W(ul_open())
...
W(ul_open())
W(li("No longer has decreased number of +2 All Attributes bonuses", t("NERF")))
W(li("Heart of Darkness: No longer reduces Night Stalker's health regeneration by 20% during the day", t("NERF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(hero_header("Ogre Magi"))
W(ul_open())
W(li("Base Damage increased by 1", bstat_h("Ogre Magi", "AttackDamageMin", "7.39e", 1)))
W(li("Damage at level 1 increased from 69–75 to 70–76", t("BUFF")))
W(ul_close())
W(ability("Bloodlust"))
W(ul_open())
W(li("Cast range increased from 600 to 650", b(600, 650)))
W(li("Can no longer target invulnerable units", t("NERF")))
W(li("Can still target invulnerable buildings (i.e. Tier 2-4 towers when the previous ones are not destroyed)", t("MISC")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(hero_header("Omniknight"))
W(ul_open())
W(li("Base Armor increased by 1", bstat_h("Omniknight", "ArmorPhysical", "7.39e", 1)))
W(ul_close())
W(ability("Repel", slug="omniknight_martyr"))
W(ul_open())
...
W(ability("Hammer of Purity"))
W(ul_open())
W(li("No longer disabled by Silence", t("NERF")))
W(ul_close())
W(ability("Guardian Angel"))
W(ul_open())
...
W(ul_open())
W(li("Can no longer target invulnerable units, but does affect invulnerable units in the AoE", t("NERF")))
W(ul_close())
W(ability("Fates Edict"))
W(ul_open())
W(li("No longer has separate effects for allies and enemies", t("NERF"), extra=inline_note("Always disarms the target and grants them 100% magic damage resistance")))
...
W(hero_header("Pangolier"))
W(ul_open())
W(li("Removed Double Jump and Thunderbolt facets", t("MISC")))
W(ul_close())
W(ability("Swashbuckle"))
W(ul_open())
W(li("Cooldown decreased from 21/18/15/12s to 20/17/14/11s", b([21, 18, 15, 12], [20, 17, 14, 11], l=True)))
W(li("Now briefly slows enemies movespeed on hit by 100% for 0.4s", t("REWORK")))
W(ul_close())
W(ability("Shield Crash"))
W(ul_open())
...
W(li("Barrier changed from 50/100/150/200 per enemy hero hit to 60/120/180/240 if any enemy hero is hit", t("MISC")))
W(li("If no enemy hero was hit, barrier is not provided", t("MISC")))
...
W(li("No longer slows enemies", t("NERF")))
...
W(li("No longer decreases the cooldown of Shield Crash", t("NERF")))
W(li("Now takes 1 second to reach full Roll Speed", t("REWORK")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ability("Phantom Strike"))
W(ul_open())
W(li("11/9/7/5s cooldown replaced with 2 charges with 21/18/15/12s base charge restore time", t("REWORK")))
W(ul_close())
...
W(li("Removed Divergence and Lancelot facets", t("MISC")))
W(ul_close())
W(ability("Illusory Armaments"))
W(ul_open())
W(li("Ability Reworked", t("MISC")))
W(li("Whenever an illusion of Phantom Lancer is created, it can't have less than 18% of Phantom Lancer's damage for 3s. Damage increases by 2% with every 3 Phantom Lancer's level ups", t("NERF")))
W(ul_close())
W(ability("Phantom Rush", slug="phantom_lancer_phantom_edge"))
W(ul_open())
W(li("No Longer provides bonus Agility while active", t("NERF")))
W(li("Cooldown rescaled from 13/10/7/4s to 15/11/7/3s", b([13, 10, 7, 4], [15, 11, 7, 3], l=True)))
W(li("Now provides 20/30/40/50% evasion while rushing", t("REWORK")))
W(li("No longer has a 2s linger effect", t("NERF")))
W(li("Evasion bonus is lost once the target is reached or the rush is cancelled", t("MISC")))
W(ul_close())
W(ability("Juxtapose"))
W(ul_open())
...
W(ability("Sun Ray"))
W(ul_open())
W(li("Health Cost per second decreased from 6% to 5%", b(6, 5)))
...
# Primal Beast
W(hero_header("Primal Beast"))
W(ability("Hero Facet 3 Primal Beast Pulverize"))
W(ul_open())
W(li("AoE Bonus per slam decreased from 25% to 20%", b(25, 20)))
W(ul_close())
...
W(ability("Puckish"))
W(ul_open())
W(li("No longer applies when disjointing attacks from buildings", t("NERF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 20 Talent Waning Rift Cooldown Reduction decreased from 3s to 2.5s", b(3, 2.5, l=True)))
W(ul_close())

# Pugna
W(hero_header("Pugna"))
W(ability("Hero Facet 1 Pugna Nether Ward"))
W(ul_open())
W(li("Damage to Heal decreased from 25% to 20%", b(25, 20)))
W(li("Damage to Mana decreased from 30% to 20%", b(30, 20)))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 15 Talent Health decreased from +350 to +300", b(350, 300)))
...
# Razor
W(hero_header("Razor"))
W(ability("Hero Facet 1 Razor Eye of The Storm"))
W(ul_open())
W(li("Storm Surge Cooldown Reduction decreased from 2.5s to 2s", b(2.5, 2, l=True)))
W(ul_close())
W(ability("Storm Surge"))
W(ul_open())
...
W(hero_header("Riki"))
W(ul_open())
W(li("Removed Contract Killer and Exterminator facets", t("MISC")))
W(ul_close())
W(ability("Innate Backstab"))
W(ul_open())
W(li("No longer levels with Cloak and Dagger", t("NERF")))
W(li("Agility Damage Multiplier rescaled from 0.55/0.9/1.25/1.6 to 0.6 + 0.05 per Riki's level up", b([0.55, 0.9, 1.25, 1.6], 0.6)))
W(li("Now works on allied units at 25% effectiveness", t("REWORK")))
W(li("Damage is now done as a separate instance of damage instead of a part of the attack damage", t("REWORK")))
W(ul_close())
W(ability("Blink Strike"))
W(ul_open())
W(li("2 charges with 25/21/17/13s base restore time replaced with 13/10/7/4s cooldown", t("REWORK")))
W(li("Bonus 40/55/70/85 magic damage replaced with 15/30/45/60 bonus physical damage on attack", t("REWORK")))
W(ul_close())
W(ability("Tricks of The Trade"))
W(ul_open())
...
W(li("40% Attack Damage replaced with 30/50/70/90 flat damage", t("REWORK")))
W(li("Still applies bonus damage from Backstab, but as a separate instance of damage now", t("REWORK")))
W(li("No longer provides bonus Agility", t("NERF")))
W(li("Now attacks 2 random targets by default", t("REWORK")))
W(li("Aghanim's Scepter slightly reworked", t("MISC")))
W(li("No longer increases the number of targets attacked", t("NERF")))
W(li("Now also allows to hide within allied creeps", t("REWORK")))
W(li("Now increases ability duration by 1s and attack count by 2, but only when Riki hides within an ally", t("REWORK")))
W(li("No longer increases attack count on non-ally casts", t("NERF")))
W(li("Now provides 15% bonus movement speed to the ally Riki's hiding in", t("REWORK")))
W(ul_close())
W(ability("Backstab"))
W(ul_open())
W(li("Now grants 130/260/390 experience when getting a hero kill and 100 experience when getting a hero assist", t("REWORK")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(hero_header("Rubick"))
W(ul_open())
W(li("Base damage increased by 1", bstat_h("Rubick", "AttackDamageMin", "7.39e", 1)))
W(li("Damage at level 1 increased from 49–55 to 50–56", t("BUFF")))
W(ul_close())
W(ability("Telekinesis"))
W(ul_open())
W(li("Land sub-ability no longer cancels channeling or interrupts movement", t("NERF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(subgroup("Talents"))
W(ul_open())
W(li("Level 20 Talent Burrowstrike Cooldown Reduction increased from 2s to 3s", b(2, 3, l=True)))
...
W(ul_close())
W(ability("Demonic Purge"))
W(ul_open())
W(li("Can no longer target invulnerable units", t("NERF")))
W(ul_close())
W(ability("Demonic Cleanse"))
W(ul_open())
W(li("Can no longer target invulnerable units", t("NERF")))
W(ul_close())
...
# Shadow Shaman
W(hero_header("Shadow Shaman"))
W(ability("Hero Facet 3 Shadow Shaman Mass Serpent Ward"))
W(ul_open())
W(li("Health and Bounty multiplier decreased from 10x to 9x", t("NERF"), extra=inline_note(" Hits to destroy decreased from 20 to 18, Gold Bounty decreased from 220–300 to 198–270, XP Bounty decreased from 310 to 279")))
W(ul_close())
W(ability("Shackles"))
W(ul_open())
W(li("Total Damage/Heal increased from 70/140/210/280 to 100/160/220/280", b([70, 140, 210, 280], [100, 160, 220, 280])))
W(ul_close())
W(ability("Mass Serpent Ward"))
W(ul_open())
...
W(subgroup("Talents"))
W(ul_open())
W(li("Level 10 Talent Arcane Curse Penalty Multiplier decreased from +0.5 to +0.25", b(0.5, 0.25, l=True)))
W(ul_close())
...
W(subgroup("Talents"))
W(ul_open())
W(li("Level 15 Talent Ancient Seal Cooldown Reduction decreased from 7s to 6s", b(7, 6, l=True)))
...
W(hero_header("Slark"))
W(ul_open())
W(li("Removed Leeching Leash and Dark Reef Renegade facets", t("MISC")))
W(li("Removed Barracuda innate ability (effect moved to the Ultimate)", t("MISC")))
W(ul_close())
W(ability("Essence Shift"))
W(ul_open())
W(li("Now an innate ability. Passive, improves with Slark's level", t("REWORK")))
W(li("Duration rescaled from 15/35/55/75s to 15s + 2.5s each time Slark levels up", b([15, 35, 55, 75], 15)))
W(ul_close())
W(ability("Pounce"))
W(ul_open())
W(li("Now applies 1/2/3/4 Essence Shift stacks when leashing an enemy hero", t("REWORK")))
W(ul_close())
W(ability("Saltwater Shiv"))
W(ul_open())
W(li("New basic ability. Passive, auto-cast attack modifier", t("MISC")))
W(li("Slark slices the target with his salty shiv, stealing 3 Movement Speed, 3 Health Regen and 3/4/5/6% Health Restoration from them with each attack. Subsequent use of Saltwater Shiv refreshes the duration of all shiv stacks. Steal duration: 6/8/10/12s. Mana Cost: 20. Cooldown: 10/8/6/4s", t("MISC")))
W(li("Not Breakable. Disabled by Silence. Has no stack limit. Ignores attack backswing", t("MISC")))
W(li("Enemies with Health Restoration below -100% will not lose health from health restoration sources", t("MISC")))
W(ul_close())
W(ability("Shadow Dance"))
W(ul_open())
W(li("Now passively grants 24/36/48% movement speed and 60/90/120 health regen when unseen", t("REWORK")))
W(li("Previous Barracuda rules and mechanics unchanged", t("MISC")))
W(ul_close())
W(ability("Depth Shroud"))
W(ul_open())
W(li("Duration decreased from 3s to 2s", b(3, 2)))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 10 Talent Dark Pact Cooldown Reduction increased from 0.5s to 0.75s", b(0.5, 0.75, l=True)))
...
W(hero_header("Snapfire"))
W(ul_open())
W(li("Buckshot: Now affects only attacks made on enemy heroes", t("REWORK")))
W(li("Attacks on non-heroes can still ricochet on miss, but they won't have extra damage or glance chance", t("MISC")))
W(ul_close())
W(ability("Firesnap Cookie"))
W(ul_open())
...
W(hero_header("Spectre"))
W(ul_open())
W(li("Now an Agility Hero", t("REWORK")))
W(li("Base Damage increased by 2", bstat_h("Spectre", "AttackDamageMin", "7.39e", 2)))
...
W(li("Damage at level 30 decreased by 27 (from 149–153 to 122–126)", t("NERF")))
W(li("Base Attack Time worsened from 1.7s to 1.8s", b(1.7, 1.8, l=True)))
W(li("Base Attack Speed increased from 90 to 110", b(90, 110)))
W(li("Removed Forsaken and Twist the Knife facets", t("MISC")))
W(li("Removed Spectral innate ability", t("MISC")))
W(ul_close())
W(ability("Desolate"))
W(ul_open())
W(li("Now an innate ability. Passive, improves with Spectre's level", t("REWORK")))
W(li("Damage rescaled from 25/40/55/70 to 25 + 2 every time Spectre levels up", b([25, 40, 55, 70], 25)))
W(ul_close())
W(ability("Spectral Dagger"))
W(ul_open())
W(li("Mana Cost decreased from 110/120/130/140 to 100/110/120/130", b([110, 120, 130, 140], [100, 110, 120, 130], l=True)))
W(li("Spectre's illusions now also benefit from the Shadow Path", t("REWORK")))
W(ul_close())
W(ability("Shadow Step"))
W(ul_open())
W(li("Reworked into a basic ability", t("MISC")))
W(li("Thrusts an uncontrollable illusion, which follows the target and attacks it for 20/30/40/50% of Spectre's damage. The illusion exists for 3.5/4/4.5/5 seconds, and takes 200% damage. Cast Range: 700/850/1000/1150. Mana Cost: 60/65/70/75. Cooldown: 32/28/24/20s", t("MISC")))
W(li("On cast the illusion moves at the speed of 900, then it has 135% of Spectre's movement speed after reaching the target", t("MISC")))
W(li("The Reality sub-ability may be used to teleport to the illusion, destroying it", t("MISC")))
W(ul_close())
W(ability("Dispersion"))
W(ul_open())
...
W(li("Now has a distinct sound between casts on Shadow Step and Haunt illusions", t("REWORK")))
W(li("Mana Cost decreased from 40 to 25", b(40, 25, l=True)))
W(li("Now has a 0.2s travel time to reach the target. The illusion and Spectre are invulnerable during this time", t("REWORK")))
W(li("Now disabled by roots", t("REWORK")))
W(li("Now always destroys the target illusion", t("REWORK")))
W(ul_close())
W(ability("Haunt"))
W(ul_open())
W(li("Now Spectre's ultimate ability", t("REWORK")))
W(li("Mana Cost rescaled from 150 to 125/150/175", b(150, [125, 150, 175], l=True)))
W(li("Duration rescaled from 6s to 5/6/7s", b(6, [5, 6, 7], l=True)))
...
W(li("Each illusion now spawns from the direction closest to Spectre", t("REWORK")))
W(li("Now upgraded with Aghanim's Scepter", t("REWORK")))
W(li("Reduces Haunt cooldown by 20s. When Reality is used on Haunt illusion for the first time per Haunt cast, enemies are Feared away from Spectre for 1.5s with 50% reduced move speed in a 400 AoE around the targeted illusion", t("MISC")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ability("Galvanized"))
W(ul_open())
W(li("Charge loss on death decreased from 3 to 2", b(3, 2)))
W(ul_close())
W(ability("Overload"))
W(ul_open())
...
W(ability("Storm Hammer", slug="sven_storm_bolt"))
W(ul_open())
W(li("Aghanim's Scepter no longer allows targeting invulnerable units, but still affects invulnerable units in the radius", t("NERF")))
W(li("Aghanim's Scepter cast range bonus changed from +350 to +25%", b(350, 25), extra=inline_note("Decreased from +350 to +150")))
W(li("Aghanim's Scepter now also increases projectile speed by 25%", t("REWORK"), extra=inline_note("From 1000 to 1250")))
W(ul_close())
W(ability("Great Cleave"))
W(ul_open())
...
W(li("Damage at level 1 increased by 1 (from 46–48 to 47–49)", t("BUFF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ability("Avalanche"))
W(ul_open())
W(li("Stun duration now applies its stun as an aura in the area", t("REWORK")))
W(li("As a result, no longer affected by status resistance", t("NERF")))
W(ul_close())
W(ability("Toss Tree"))
W(ul_open())
W(li("No longer has separate damage bonus, uses Tree Grab's value instead", t("NERF")))
...
W(hero_header("Treant Protector"))
W(ul_open())
W(li("Removed Primeval Power and Sapling facets", t("MISC")))
W(ul_close())
W(ability("Natures Guise"))
W(ul_open())
W(li("No longer upgraded with Aghanim's Shard", t("NERF")))
W(li("Now can be activated while tree walking to make Treant Protector invisible until he attacks or loses the Nature's Guise buff", t("REWORK")))
W(li("Linger time: 2s. No Mana Cost. Cooldown: 50s. Cooldown is reduced by 3s per 2 Treant Protector's level ups", t("MISC"), extra=inline_note("Down to 8 seconds on level 29")))
W(li("Cooldown starts when the invisibility ends", t("MISC")))
W(ul_close())
W(ability("Nature's Grasp"))
W(ul_open())
W(li("No longer does 50% more damage and slow when touching a tree", t("NERF")))
...
W(li("Creep penalty decreased from 50% to 35%", b(50, 35, l=True)))
W(ul_close())
W(ability("Leech Seed"))
W(ul_open())
W(li("Ability Reworked", t("MISC")))
W(li("Passive, auto-cast attack modifier", t("MISC")))
W(li("Treant Protector's attack plants a life-sapping seed in an enemy unit, dealing an extra 20/40/60/80 magic damage. The enemy is bound for 0.9/1.1/1.3/1.5s and emits two healing pulses, one upon application and one upon expiration, healing up to 5 allies within 650 units for 15/25/35/45 + 20% of the damage dealt by the attack. No Mana Cost. Cooldown: 15/12/9/6s. Breakable", t("MISC")))
W(li("Now only sends out a maximum of 5 heals per pulse, prioritizing heroes", t("REWORK")))
W(li("No longer has a creep penalty for healing", t("BUFF")))
W(ul_close())
W(ability("Living Armor"))
W(ul_open())
W(li("No longer grants bonus armor", t("NERF")))
W(li("Now grants 100 damage block from player-controlled sources. Each time this spell blocks damage the effect is decreased by 35/30/25/20", t("REWORK")))
W(li("Damage block affects any types of damage", t("MISC")))
...
W(ul_close())
W(ability("Overgrowth"))
W(ul_open())
W(li("Now upgraded with Aghanim's Scepter", t("REWORK")))
W(li("Decreases cooldown from 110/100/90 to 80/70/60s. When casting Overgrowth, Treant Protector draws power from the earth, becoming massive for 16 seconds, gaining +100% Strength, Phased Movement, and a Splashing Attack that deals 60% of attack damage in a 300 unit radius. While large, he has a fixed movement speed of 345. Buff is undispellable", b([110, 100, 90], [80, 70, 60], l=True)))
W(ul_close())
W(ability("Eyes in the Forest"))
W(ul_open())
W(li("Now granted by Aghanim's Shard", t("REWORK")))
W(li("Mana Cost decreased from 100 to 30", b(100, 30, l=True)))
W(li("Cast Range increased from 160 to 350", b(160, 350, l=True)))
W(li("Overgrowth is no longer applied around enchanted trees", t("NERF")))
W(li("Enchanted trees now have the same health as Observer Wards, and they expire after 5 minutes", t("REWORK")))
W(li("Trees can be attacked when revealed by True Sight. Attacks will remove the ability effect from the tree without destroying the tree itself", t("MISC")))
...
W(hero_header("Underlord"))
W(ul_open())
W(li("Strength gain increased from 3.0 to 3.2", b(3.0, 3.2)))
...
# Ursa
W(hero_header("Ursa"))
W(ability("Earthshock"))
W(ul_open())
W(li("Aghanim's Shard Reworked", t("MISC")))
W(li("Applies 3 Fury Swipe stacks to each affected enemy", t("MISC")))
W(ul_close())
W(ability("Enrage"))
W(ul_open())
...
# Venomancer
W(hero_header("Venomancer"))
W(ability("Hero Facet 2 Venomancer Venomous Gale"))
W(ul_open())
...
# Viper
W(hero_header("Viper"))
W(ability("Hero Facet 2 Viper Corrosive Skin"))
W(ul_open())
W(li("Time to max effect increased from 4s to 5s", b(4, 5)))
W(ul_close())
W(ability("Poison Attack"))
W(ul_open())
...
# Visage
W(hero_header("Visage"))
W(ability("Grave Chill"))
W(ul_open())
W(li("Move Speed Drain increased from 12/16/20/24% to 12/18/24/30%", b([12, 16, 20, 24], [12, 18, 24, 30])))
W(ul_close())
W(ability("Gravekeepers Cloak"))
W(ul_open())
W(li("Familiars now have their own copy of Gravekeeper's Cloak ability (visual change only)", t("REWORK")))
W(ul_close())
W(ability("Summon Familiars"))
W(ul_open())
W(li("Familiars now have their own ability to independently recall it to Visage", t("REWORK")))
W(li("The alt cast behavior on Visage is unchanged", t("MISC")))
W(li("The 3rd Familiar gained by Level 25 Talent is now automatically added to an existing control group when created", t("REWORK")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ability("Resonant Pulse"))
W(ul_open())
W(li("Aghanim's Scepter Silence duration decreased from 2.0 to 1.75s", b(2.0, 1.75)))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(ul_close())
W(ability("Time Lapse"))
W(ul_open())
W(li("Aghanim's Scepter now also reduces Cooldown by 10s", t("REWORK")))
W(ul_close())
...
W(hero_header("Winter Wyvern"))
W(ul_open())
W(li("Base damage increased by 1", bstat_h("Winter Wyvern", "AttackDamageMin", "7.39e", 1)))
W(li("Damage at level 1 increased from 41–48 to 42–49", t("BUFF")))
...
# Witch Doctor
W(hero_header("Witch Doctor"))
W(ability("Hero Facet 4 Witch Doctor Maledict"))
W(ul_open())
W(li("Burst damage does not apply from non-hero units", t("MISC")))
W(ul_close())
W(ability("Voodoo Restoration"))
W(ul_open())
...
W(ability("Maledict"))
W(ul_open())
W(li("Now also affects player-controlled creeps", t("REWORK")))
W(ul_close())
W(ability("Death Ward"))
W(ul_open())
