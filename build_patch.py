...
W(item_header("Dagon"))
W(ul_open())
W(li("Recipe cost decreased from 1150 to 1100", b(1150, 1100, l=True), extra=inline_note("Total cost decreased from 3050/4200/5350/6500/7650g to 3000/4100/5200/6300/7400g — " + b([3050, 4200, 5350, 6500, 7650], [3000, 4100, 5200, 6300, 7400], l=True))))
W(ul_close())
...
W(ul_open())
W(li("Using Smoke of Deceit now broadcasts a chat message in allied chat", t("MISC")))
W(ul_close())
...
W(ul_open())
W(li("Linger delayed damage is now non-lethal if the incoming damage source was non-lethal", t("MISC"), extra=inline_note("Fixes a bug where a hero could kill themselves with their own non-lethal damage (e.g. Huskar)")))
W(ul_close())
...
W(ul_open())
W(li("No longer procs Magic Stick or its upgrades", t("MISC")))
W(ul_close())
...
W(ul_open())
W(li("Pushback and damage now apply against heroes with no mana", t("MISC")))
...
W(li("Max Base damage increased by 1", bstat_h("Outworld Destroyer", "AttackDamageMax", "7.41c", 1), extra=inline_note("Damage at level 1 increased from 49-61 to 53-62. Damage spread decreased from 12 to 9")))
W(ul_close())
...
W(ul_open())
W(li("Base Damage increased by 2", bstat_h("Wraith King", "AttackDamageMin", "7.41c", 2), extra=inline_note("Damage at level 1 increased from 60-62 to 62-64")))
W(ul_close())
...
W(ul_open())
W(li("Recipe cost increased from 350 to 450 " + b(350, 450, l=True) + ". Total cost unchanged at 2150 due to Shadow Amulet cost decrease", t("MISC")))
W(ul_close())
...
W(ul_open())
W(li("Recipe cost increased from 800 to 1340 " + b(800, 1340, l=True) + ". Total cost unchanged at 2250 due to Iron Branch cost increase", t("MISC")))
...
W(ul_open())
W(li("Recipe cost increased from 200 to 1600 " + b(200, 1600, l=True) + ". Total cost unchanged at 5000 due to Ring of Tarrasque and Tiara of Selemene cost decrease", t("MISC")))
...
W(item_header("Revenant's Brooch"))
W(ul_open())
W(li("Recipe cost increased from 600 to 650 " + b(600, 650, l=True) + ". Total cost unchanged at 3300 due to Voodoo Mask cost decrease", t("MISC")))
W(ul_close())
