...
W(li("No longer upgraded with Aghanim's Shard", t("DEL")))
W(li("Aghanim's Scepter: Allows Brewmaster to cancel the ability early and provides Brewed Up bonus to all Brewlings on cast. Also increases ability's level to 4, improving Brewlings' stats and abilities<br>Earth: 4100 Health, 8 Health Regen, 135–145 Damage, 9 Armor. Other base stats are unchanged<br>Hurl Boulder: 200 Damage and 2s Stun Duration", t("NEW")))
